...
const product = {
  ...
  href: '#',
  breadcrumbs: [
    { id: 1, name: 'Souvinir Shop', href: '/shopcategory' },
    { id: 2, name: 'Magnet', href: '/shopviewmagnet' },
  ],
  images: [
    {
    ...
    <div className="bg-white">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          <ol
            role="list"
            className="mt mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8"
          >
                        ...
                        <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                          <p>
                            ...
                            <Link to="/shopcategory">
                              <button
                                type="button"
                                className="ms-2 font-medium text-indigo-600 hover:text-indigo-500"
                              >
                                Continue Shopping
