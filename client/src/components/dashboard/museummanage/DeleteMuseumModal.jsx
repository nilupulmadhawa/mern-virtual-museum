...
import { deleteMuseum, editMuseum } from '../../../services/museum';

export default function DeleteMuseumModal({ row, getTableData }) {
    ...
    const _deleteMuseum = async (e) => {
        e.preventDefault();
        setLoading(true)
        try {
            deleteMuseum(form._id).then((res) => {
                setLoading(false);
                if (res.success) {
                    getTableData()
                                                                    ...
                                                                    <div class="flex items-center space-x-5">
                                                                        ...
                                                                        <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                                                            <h2 class="leading-relaxed">
                                                                                Delete Museum Exhibit
                                                                            </h2>
                                                                            <p class="text-sm text-gray-500 font-normal leading-relaxed">
                                                                                Are you sure you want to delete this museum exhibit?
                                                                            </p>
                                                                        </div>
                                                                    </div>
