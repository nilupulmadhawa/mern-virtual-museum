...
const Navbar = ({ logout }) => {
    ...
    const guestLinks = () => (
        <>
            ...
            {!token ? <li className="nav-item text-sm">
                <Link
                    className={
    ...
    return (
        <>
            <div className="container mx-auto block relative text-white z-50">
            ...
            >
              <MDBIcon fas icon={open ? 'close' : 'bars'} />
                        ...
                        <ul
                            className={`md:flex md:items-center justify-center md:pb-0 pb-12 absolute md:static md:z-auto z-50 left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20' : 'top-[-490px]'
                                } md:p-0 md:m-0
  `}
