      ...
      <div class="max-w-md mx-auto">
        <div class="flex items-center space-x-5">
          ...
          <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
            ...
            <p class="text-sm text-gray-500 font-normal leading-relaxed">Add new Event for the Virtual Museum.</p>
          </div>
        </div>
          ...
          <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
            ...
            <div class="flex items-center space-x-4">
              ...
              <div class="flex flex-col">
                ...
                <div class="relative focus-within:text-gray-600 text-gray-400">
                  <input type="text" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="10/05/2023"/>
                  <div class="absolute left-3 top-2">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                  </div>
                </div>
